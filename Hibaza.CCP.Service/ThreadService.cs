...
//        }
//        public Domain.Entities.Thread GetByIdFromCustomerId(string customerId)
//        {
//            return _threadRepository.GetByIdFromCustomerId(customerId);
//        }
...
//            {
//                var referral = _referralService.CreateReferral(business_id, thread_id, referralEvent.timestamp.ToString(), referralEvent.sender.id, referralEvent.recipient.id, data);
//            }
//            return true;
//        }
...
//                //thread.unread = thread.unread || (thread.channel_ext_id != thread.sender_ext_id || (string.IsNullOrWhiteSpace(message.agent_id) && thread.type == "message"));
//                //thread.nonreply = thread.nonreply || (thread.channel_ext_id != thread.sender_ext_id || (string.IsNullOrWhiteSpace(message.agent_id) && thread.type == "message"));
